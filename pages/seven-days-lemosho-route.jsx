...
const ThreeDaysItenary = () => {
  return (
    <Layout extraClass={"pt-160"}>
      <PageBanner pageTitle={"Lemosho Route"} />
                  ...
                  {/* Itenary 01 */}
                   ...
                   <div className="main-post mt-4">
                    <div className="entry-content">
                      ...
                      <div className="tag-links">
                      <h6>Day 2 :</h6>
                      <a>Mti Mkubwa Camp – Shira I Camp</a>
                    </div>
                    </div>
                      <p>
                  ...
                  {/* Itenary 06 */}
                   ...
                   <div className="main-post mt-4 block-quote">
                    <div className="entry-content">
                      ...
                      As the weather is drastically warmer, the terrain is wet, muddy and steep and we highly recommend Gaiters and trekking poles.<br/><br/>
